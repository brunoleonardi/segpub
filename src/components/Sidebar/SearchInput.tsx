...
export const SearchInput: React.FC<SearchInputType> = ({ setIsOpen, address, setAddress }) => {
                ...
                {suggestions.map((s, i) => {
                    ...
                    return (
                        <div
                            ...
                            className={`px-4 py-2 cursor-pointer rounded-md text-xs leading-tight truncate ${isHighlighted
                                ? isDarkMode
