...
export const CreatePOIModal: React.FC<CreatePOIModalProps> = ({ open, onOpenChange }) => {
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className={`border-none rounded-2xl w-[400px] backdrop-blur-[2px] px-6 pt-5 shadow-md cursor-default z-50 ${isDarkMode ? 'bg-zinc-900/60' : 'bg-[#EFF4FA]/70'}`}>
        <DialogHeader>
